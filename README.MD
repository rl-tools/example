...
This example implements a full pendulum environment including a visualization in `191` lines of code (`115` for then environment + `76` for the UI). You can find the implementation in [include/my_pendulum](./include/my_pendulum)
## UNIX (Linux / macOS)
```
